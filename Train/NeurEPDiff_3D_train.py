...
snapshot_path = 'DIRECTORY_TO_SAVE_YOUR_MODEL'
...
path_model = snapshot_path+ 'MODEL_NAME' #.pth format
final_model =  snapshot_path+ 'MODEL_NAME' #.pth format


################################################################
# load data
################################################################
train_data = Field_dataset("DIRECTORY_OF_TRAINING_DATA", "train", "velocity", ntrain)
test_data = Field_dataset("DIRECTORY_OF_TESTING_DATA", "test", "velocity", ntest)
